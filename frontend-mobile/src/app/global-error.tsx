...
export default function GlobalError({
  ...
  const errorContent = {
    "429": {
      ...
      description: "Вы отправляете слишком много запросов. Пожалуйста, подождите минуту и обновите страницу."
    },
    "403": {
      title: "ACCESS DENIED (403)",
      description: "У вас нет прав для просмотра этой страницы или запроса этих данных."
    },
    "500": {
      title: "SERVER ERROR (500)",
      description: "На сервере произошел непредвиденный сбой. Мы уже занимаемся восстановлением работы сервиса."
    }
  }[status] || {
