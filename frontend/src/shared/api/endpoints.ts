...
export const CATEGORY_LIST_PRODUCT =
  PUBLIC_API_BASE_URL + "/search-by-category";
...
export const SUGGEST = PUBLIC_API_BASE_URL + "/suggest";

export const SIZE_TABLE = (spuId: number) =>
  PUBLIC_API_BASE_URL + `/size-table/${spuId}`;
