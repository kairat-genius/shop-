    ...
    <div className="flex items-start justify-between">
      <div className="flex flex-wrap">
        <Button
          ...
          className="border border-slate-300 bg-white px-3 mr-3 mb-3 h-9 rounded-sm text-base"
        >
        ...
        {filters.categories.map((catId) => (
          <div
            key={catId}
            className="flex gap-2 items-center justify-between mr-3 mb-3 px-3 h-9 text-base bg-slate-150 rounded-sm"
          >
      ...
      <div className="mb-4 ml-4 lg:ml-8 flex gap-2 items-center justify-end">
        <span className="text-xl font-bold font-roboto_condensed leading-[1.2]">
          СОРТИРОВАТЬ ПО:
        </span>
        <Select
          value={filters.sort}
